...
void Deferred::SetupResources()
{
...

	{
		...
		// Specular (11bit, contains reflection and so on)
		SetupRenderTarget(SPECULAR, texDesc, srvDesc, rtvDesc, uavDesc, DXGI_FORMAT_R11G11B10_UNORM, D3D11_BIND_RENDER_TARGET | D3D11_BIND_SHADER_RESOURCE);
		...
		// Normal + Roughness (can stay 10-bit)
